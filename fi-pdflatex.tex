...
Is the layer directly called from views. It delegates most operations to its corresponding services. In this project, controllers are referred to as \textbf{providers} due to naming conventions associated with the widespread Provider library \textcite{providerPackage}, which builds upon Flutter's `ChangeNotifier` class \textcite{flutterChangeNotifier}.  
